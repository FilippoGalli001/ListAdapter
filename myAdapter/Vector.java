 ...
 *
 * <p>
 * The object {@link myAdapter.Vector} is used to save e manage data, the purpose of this class is only to filter the methods of vector in order to use only methods from CLDC1.1
 *
